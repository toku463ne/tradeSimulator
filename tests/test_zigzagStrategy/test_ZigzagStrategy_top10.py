...
class TestPeakStrategy(unittest.TestCase):
    ...
    def _run(self, st, ed, os):
        ...
        "codenames": [],
        "use_master": True,
        "exclude_codes": ["^%", "2038.T", "7383.T", "6524.T", "4259.T", "9258.T", "4268.T", "5031.T"],
        "n_targets": 10}
        ...
        executor = Executor()
        portforio = Portoforio("test_zigzag_top10", 10000000, 0)
    ...
    def testCase1(self):
        ...
        db = PostgreSqlDB()
        self.assertEqual(db.countTable("trades", ["trade_name = 'test_zigzag_top10'"]), 1)
